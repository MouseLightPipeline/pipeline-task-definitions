...
# Unused - tile_name=${4}
fluorescence_root=${5}
other_tile_relative_path=${6}
mouselight_toolbox_path=${7}


# User-defined arguments
app="${mouselight_toolbox_path}//compute_z_matches.sh"
#pythonFolder=${6}
...
cmd="${app} ${pipeline_input_root} ${pipeline_output_root} ${tile_relative_path} ${fluorescence_root} ${other_tile_relative_path}"
echo "${cmd}"
eval "${cmd}"
