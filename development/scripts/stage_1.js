...
const expected_exit_code = process.argv.length > 9 ? process.argv[9] : null;
const task_id = process.argv.length > 10 ? process.argv[10] : null;
const is_cluster_job = process.argv.length > 11 ? process.argv[11] : null;
